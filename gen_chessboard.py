...
for i in range(nb_img):
        ...
        for j in range(nb_pieces):
                ...
                for k in range(nb_ajout):
                    ...
                    board.set_piece_at(square=square, piece=chess.Piece.from_symbol(piece))
                    board_svg = chess.svg.board(board, coordinates=False)
                    svg2png(bytestring=board_svg, write_to=f"/Users/leilaelamine/PycharmProjects/Seven_diff_chess/img_chess/board_png/chess_{i}_{j}_{k}.png")
                    im01 = Image.open(f'/Users/leilaelamine/PycharmProjects/Seven_diff_chess/img_chess/board_png/chess_{i}_{j}_{0}.png')
